...
describe Mongoid::Tree::RationalNumbering do
  ...
  describe 'when saved' do
    ...
    it "should assign a rational number to each node" do
      node(:node_1).rational_number_nv    = 2
      node(:node_1).rational_number_dv    = 1
      node(:node_1).rational_number_snv   = 3
      node(:node_1).rational_number_sdv   = 1
      
      node(:node_1_1).rational_number_nv  = 5
      node(:node_1_1).rational_number_dv  = 2
      node(:node_1_1).rational_number_snv = 8
      node(:node_1_1).rational_number_sdv = 3
      
      node(:node_1_2).rational_number_nv  = 8
      node(:node_1_2).rational_number_dv  = 3
      
      node(:node_2).rational_number_nv    = 3
      node(:node_2).rational_number_dv    = 1
      node(:node_2).rational_number_snv   = 4
      node(:node_2).rational_number_sdv   = 1
    end
